...
namespace ReMUD.Server.Output
{
    ...
    public static class AnsiHandler
    {
        ...
        {
            get { return Esc + "[2J" + Esc + "[1;1H"; }
        }

        /// <summary>Gets the 'clear to end of line' ANSI sequence.</summary>
        public static string ClearToSOL
        {
            get { return Esc + "[79D" + Esc + "[K"; }
        }
        ...
        public static string SetTextAttributes(AnsiAttribute attribute, AnsiForegroundColor foregroundColor, string text)
        { 
            return Esc + string.Format(
                "[{0};{1}m{2}",
                (int)attribute,
        ...
        public static byte[] Parse(string parseString)
        {
            ...
            if (newString != null)
            {
                ...
                return GetBytes(newString);
            }

            return GetBytes(string.Empty);
        }
    }
}